...
(define (on-left-press p)
  ...
  (set-game-object-rotational-velocity! the-player -10))
...
;;; DEFINITELY DON'T NEED TO UNDERSTAND ANYTHING
;;; BELOW HERE - though please feel free to keep
